 ...
 */
async function awaitCatcher(promise, options) {
    const settings = {
        ...
        try {
            if (options && (options.getByKeys || options.getByKeysAndInvoke)) {
                ...
                for (let key of options.getByKeysAndInvoke) {
                    ...
                    else if (options.getByKeysAndInvoke)
...
exports.awaitCatcher = awaitCatcher;
;
/**
 ...
 * @param options
 */
async function awaitCatcherAsync(promise, cb, options) {
    const [data, error] = await awaitCatcher(promise, options);
    return cb(data, error);
}
exports.awaitCatcherAsync = awaitCatcherAsync;
exports.default = { awaitCatcher, awaitCatcherAsync };
/**
 * test...
